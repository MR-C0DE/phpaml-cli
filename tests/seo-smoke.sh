...
printf '%s\n' '<?php namespace PHPAML\Config; final class Env { public static function load(string $path): void {} }' > "$fixture/project/aml_env/autoload.php"
...
cd "$fixture/project"
AML_LANG=en php "$fixture/aml_env/bin/aml.php" seo:init
AML_LANG=en php "$fixture/aml_env/bin/aml.php" seo:set title "PHPAML SEO test"
AML_LANG=en php "$fixture/aml_env/bin/aml.php" seo:set description "A complete PHPAML SEO description created to validate metadata from the command line."
AML_LANG=en php "$fixture/aml_env/bin/aml.php" seo:disallow /admin
AML_LANG=en php "$fixture/aml_env/bin/aml.php" seo:allow /admin/public

show_output="$(AML_LANG=en php "$fixture/aml_env/bin/aml.php" seo:show --json)"
grep -q '"title": "PHPAML SEO test"' <<<"$show_output"
grep -q '"type": "WebSite"' <<<"$show_output"

AML_LANG=en php "$fixture/aml_env/bin/aml.php" seo:generate
...
AML_LANG=en php "$fixture/aml_env/bin/aml.php" seo:remove allow /admin/public
if AML_LANG=en php "$fixture/aml_env/bin/aml.php" seo:show --json | grep -q '/admin/public'; then
    echo "The removed SEO rule is still configured." >&2
    exit 1
fi

audit_output="$(AML_LANG=en php "$fixture/aml_env/bin/aml.php" seo:audit http://127.0.0.1:18765 --file public/index.php --json)"
